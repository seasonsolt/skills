...
- [`writing-skill-trainer`](skills/writing-skill-trainer/): 从你的写作样本中学习，通过受控自训练生成、验证并持续进化你自己的 Writing Skill。查看 [`DeepSeek 直接生成 vs 训练后生成`](marketing/writing-skill-trainer/) 实测与完整 Skill Demos。
